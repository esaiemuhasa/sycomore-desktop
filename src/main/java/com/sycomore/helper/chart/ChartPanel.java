...
public class ChartPanel extends JPanel {
	...
	private final JButton btnPrint = new JButton("Imprimer", new ImageIcon(Config.getIcon("print")));
	private final JButton btnImg = new JButton("Exporter", new ImageIcon(Config.getIcon("saveimg")));
	...
	private void init () {
		...
		tool.setBackground(UIManager.getColor("Component.borderColor"));
		chartContainer.add(chartRender, BorderLayout.CENTER);
		chartRender.setLineAxisColor(UIManager.getColor("Component.borderColor").brighter().brighter().brighter());
